...
export const districtMasteryMilestones: DistrictMasteryMilestone[] = [
  ...
  { level: 10, name: "Local Regular", description: "+2% credits from city activities.", modifiers: { creditsGained: 0.02 }, unlockKey: "district-return-contracts" },
  ...
  { level: 20, name: "Route Intel", description: "+2% damage in combat.", modifiers: { combatDamage: 0.02 }, unlockKey: "district-operation-routes" },

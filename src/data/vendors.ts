...
export const vendors: VendorDefinition[] = [
  // ===== NEON ROW =====
  {
    ...
    priceModifier: 0.95,
    factionDiscounts: { redlineSaints: 0.07 },
  ...
  // ===== UNDERPASS MARKET =====
  {
    ...
    inventory: [
      ...
      item("market-pass", 260, "unlock", "Permanent contraband route credential.", 1),
  ...
  // ===== BLACKNET QUARTER =====
  {
    ...
    inventory: [
      ...
      item("data-job-pass", 260, "unlock", "Permanent signed access credential.", 1),
  ...
  // ===== HELIX WARD =====
  {
    ...
    inventory: [
      ...
      item("medical-access-pass", 360, "unlock", "Permanent clinic access credential.", 1),
  ...
  // ===== SKYLINE CORE =====
  {
    ...
    priceModifier: 1.5,
    factionDiscounts: { ghostMarket: 0.1 },

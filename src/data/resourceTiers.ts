...
export const resourceTierInfo: Record<string, { tier: ResourceTier; sourceHint: string }> = {
  ...
  engineCore: { tier: "advanced", sourceHint: "Vehicle bosses, Rust Yards vendors, and combat encounters." },
  ...
  "prototype-weapon-core": { tier: "rare", sourceHint: "Combat combat encounters and late Street Combat rare drops." },
  prototypeDriveUnit: { tier: "rare", sourceHint: "Late vehicle tuning, prototype vehicle rewards, and combat encounters." },
  ...
  "relic-circuit": { tier: "ultraRare", sourceHint: "Future endgame relic combat encounters." },
  ...
  "blacksite-prototype-core": { tier: "ultraRare", sourceHint: "Future blacksite combat drop." },

...
Main jobs unlock districts and award credits, crafting supplies, and local blueprints. Crafting is the main source of regular equipment. Local gigs pay credits and rotate small material rewards; each completed gig has a 5% chance to drop one unique item from its district pool. Craftable gear is excluded from these drops, and stronger unique gear appears only in later districts. Reward previews list guaranteed supplies and rare drop chances separately. Main jobs no longer replace your equipped weapon or hand out software; the finale retains one unique OS trophy. Existing inventory is preserved.
